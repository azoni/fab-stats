    ...
    <div className="max-w-3xl mx-auto py-6 px-4">
      ...
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-lg font-bold text-fab-text leading-tight">AI Chat</h1>
            <p className="text-xs text-fab-dim leading-tight">Ask about your stats, matchups, and the meta</p>
          </div>
        </div>
        {messages.length > 0 && (
          <button
