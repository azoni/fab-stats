      ...
      <head>
        <script
          dangerouslySetInnerHTML={{
            __html: `try{var t=localStorage.getItem('fab-theme');if(t){var m={arcana:'grimoire',ironheart:'grimoire',chromatic:'rosetta'};if(m[t]){t=m[t];localStorage.setItem('fab-theme',t)}document.documentElement.setAttribute('data-theme',t)}else{document.documentElement.setAttribute('data-theme','parchment')}}catch(e){}`,
          }}
        />
      </head>
      <body
        ...
        <TooltipProvider>
          ...
          <footer className="hidden md:block text-center py-4 text-[11px] text-fab-dim space-y-1">
            ...
            <p>
              ...
              {" "}&middot;{" "}
              <a href="/docs" className="hover:text-fab-text transition-colors">Docs</a>
              {" "}&middot;{" "}
              <a href="/changelog" className="hover:text-fab-text transition-colors">Changelog</a>
              {" "}&middot;{" "}
