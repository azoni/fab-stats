              ...
              <div className="relative group/tools">
                <Link href="/tools" className="block rounded-lg bg-fab-surface border border-fab-border px-4 py-3 hover:border-amber-500/30 transition-colors">
                  <div className="flex items-center gap-2.5">
                    ...
                    <span className="text-[9px] font-bold uppercase tracking-wider text-violet-400 bg-violet-400/10 border border-violet-400/20 px-1.5 py-0.5 rounded">Beta</span>
                ...
                <div className="absolute left-0 right-0 top-full pt-1 z-30 hidden group-hover/tools:block">
                  <div className="rounded-lg bg-fab-surface border border-fab-border shadow-lg overflow-hidden">
                    {[
                      ...
                      { id: "scout", label: "Event Scout", icon: "M15 10.5a3 3 0 11-6 0 3 3 0 016 0zM19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1115 0z" },
                      { id: "cheatsheet", label: "Cheat Sheet", icon: "M9 12h3.75M9 15h3.75M9 18h3.75m3 .75H18a2.25 2.25 0 002.25-2.25V6.108c0-1.135-.845-2.098-1.976-2.192a48.424 48.424 0 00-1.123-.08m-5.801 0c-.065.21-.1.433-.1.664 0 .414.336.75.75.75h4.5a.75.75 0 00.75-.75 2.25 2.25 0 00-.1-.664m-5.8 0A2.251 2.251 0 0113.5 2.25H15c1.012 0 1.867.668 2.15 1.586m-5.8 0c-.376.023-.75.05-1.124.08C9.095 4.01 8.25 4.973 8.25 6.108V8.25m0 0H4.875c-.621 0-1.125.504-1.125 1.125v11.25c0 .621.504 1.125 1.125 1.125h9.75c.621 0 1.125-.504 1.125-1.125V9.375c0-.621-.504-1.125-1.125-1.125H8.25zM6.75 12h.008v.008H6.75V12zm0 3h.008v.008H6.75V15zm0 3h.008v.008H6.75V18z" },
                    ].map((tool) => (
                      <Link
                        key={tool.id}
