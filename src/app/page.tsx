      ...
      {!announcementDismissed && (
        <div className="relative bg-fab-gold/10 border border-fab-gold/30 rounded-lg p-4 pr-10">
          ...
          <p className="text-sm text-fab-text">
            New: Edit the hero on any match from your Matches page, or for an entire event from your Events page. Plus, favorite players, log single matches, share head-to-head rivalry cards, and improved accuracy on playoff finishes. As always, provide any feedback!
          </p>
        </div>
      )}
