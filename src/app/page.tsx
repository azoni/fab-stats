...
function PlayoffFinishesSection({ finishes }: { finishes: PlayoffFinish[] }) {
  ...
  const categories = [
    { label: "Wins", items: champions, icon: <TrophyIcon className="w-6 h-6 text-fab-gold" />, color: "text-fab-gold", bg: "bg-fab-gold/10 border-fab-gold/30" },
    { label: "Finals", items: finalists, icon: <MedalIcon className="w-6 h-6 text-gray-300" />, color: "text-gray-300", bg: "bg-gray-400/10 border-gray-400/30" },
    { label: "Top 4", items: top4, icon: <PodiumIcon className="w-6 h-6 text-amber-600" />, color: "text-amber-600", bg: "bg-amber-600/10 border-amber-600/30" },
    { label: "Top 8", items: top8, icon: <BracketIcon className="w-6 h-6 text-blue-400" />, color: "text-blue-400", bg: "bg-blue-400/10 border-blue-400/30" },
