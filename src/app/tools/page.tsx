...
import { EventScout } from "@/components/tools/EventScout";

type Tab = "matrix" | "notes" | "prep" | "cheatsheet" | "scout";
...
export default function ToolsPage() {
  ...
  return (
    <div>
      ...
      {activeTab === "scout" && (
        <EventScout matches={matches} entries={entries} isLoaded={!!isLoaded && !lbLoading} />
      )}
      {activeTab === "cheatsheet" && (
        <CheatSheet matches={matches} entries={entries} isLoaded={!!isLoaded && !lbLoading} isAuthenticated={isAuthenticated} />
      )}
    </div>
  );
}
