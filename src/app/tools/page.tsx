...
const VALID_TABS = new Set<Tab>(["matrix", "prep", "notes"]);
...
export default function ToolsPage() {
  ...
  return (
    <div>
      ...
      {activeTab === "prep" && (
        <TournamentPrep matches={matches} entries={entries} isLoaded={!!isLoaded && !lbLoading} isAuthenticated={isAuthenticated} />
      )}
      {activeTab === "notes" && (
