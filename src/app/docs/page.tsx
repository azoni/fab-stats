...
export const metadata: Metadata = {
  title: "Docs",
  description: "How FaB Stats works — importing, Home tabs, Best Finish, Hero Mastery, Achievements, and more.",
};
...
const TOC = [
  ...
  { id: "home-workspace", label: "Home Workspace" },
  ...
  { id: "tournaments", label: "Tournament Stats" },
      ...
      <div className="flex-1 min-w-0">
        <div className="space-y-14">
          ...
          <section id="home-workspace">
            <h2 className="text-xl font-semibold text-fab-text mb-3 pb-2 border-b border-fab-border">Home Workspace</h2>
            <p className="text-sm text-fab-muted mb-3">
              The Home section is the main logged-in workspace. It keeps the high-level profile and stat summary
              on the Overview tab, then lets you switch into Matches, Events, Opponents, Trends, and Tournament
              Stats from the tab row at the top of the page.
            </p>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {[
                ["Overview", "Profile card, personal stats, filters, recent events, opponents, leaderboard ranks, trophies, and armory garden."],
                ["Matches", "Edit individual match records, clean up imported data, and review recent rounds without leaving the Home workflow."],
                ["Events", "Group matches by event, update event metadata in bulk, and audit tournament records."],
                ["Opponents", "Review player records, mark favorites, and find repeat matchups."],
                ["Trends", "Charts for rolling win rate, hero performance, event types, formats, streaks, and time-based patterns."],
                ["Tournament Stats", "Round-by-round tournament analytics, event finishes, top cuts, and competitive event performance."],
              ].map(([name, desc]) => (
                <div key={name} className="p-3 rounded-lg bg-fab-surface border border-fab-border">
                  <div className="text-sm font-medium text-fab-text">{name}</div>
                  <div className="text-xs text-fab-muted mt-1">{desc}</div>
            ...
            <p className="text-xs text-fab-dim mt-3">
              The direct URLs still work for bookmarks and sharing, but the sidebar stays lighter by keeping these
              tools grouped under Home.
            </p>
          </section>
          ...
          <section id="leaderboard">
            ...
            <div className="space-y-2 text-sm text-fab-muted">
              ...
              <p>
                <span className="font-medium text-fab-text">Home and player cards</span> — Ranked borders
                carry through the Home overview, player profiles, and share cards so top leaderboard
                placements stay visible without needing a separate spotlight module.
              </p>
            </div>
          </section>
          ...
          <section id="activity-feed">
            ...
            <div className="space-y-2 text-sm text-fab-muted">
              ...
              <p>
                <span className="font-medium text-fab-text">Discovery</span> — The global search bar is the
                fastest way to jump to players and teams, while Home keeps the personal activity and match
                management tools close to your own stats.
              </p>
            </div>
          </section>
          ...
          <section id="tournaments">
            <h2 className="text-xl font-semibold text-fab-text mb-3 pb-2 border-b border-fab-border">Tournament Stats</h2>
            <p className="text-sm text-fab-muted">
              Tournament Stats focuses on your own competitive events rather than a featured tournament feed.
              It groups rated and high-tier events, tracks records by round, summarizes top cuts and finals,
              and can be filtered by format, event type, and hero from the Home workspace.
            </p>
          </section>
