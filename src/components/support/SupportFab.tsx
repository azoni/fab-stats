...
const LINKS: { href: string; label: string; trackKey: string; badge?: string; icon: ReactNode }[] = [
  ...
  { href: "https://www.amazon.com/?tag=fabstats-20", label: "Amazon", trackKey: "amazon", badge: "Free", icon: <ShoppingCart className="w-3.5 h-3.5" /> },
    ...
    <>
      ...
      >
        ...
        >
          ...
          <span className="max-w-0 overflow-hidden whitespace-nowrap group-hover/fab:max-w-[4rem] transition-all duration-200">
            Support
          </span>
        </Link>
      </div>
