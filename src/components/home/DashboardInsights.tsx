      ...
      {hasHeroes && (
        <div className="bg-fab-surface border border-fab-border rounded-lg overflow-hidden">
          <div className="flex items-center justify-between px-4 py-2.5 border-b border-fab-border/50">
            ...
            <Link href="/trends" className="text-xs font-semibold text-fab-gold hover:bg-fab-gold/10 px-2 py-0.5 rounded-md transition-colors">
              Full stats &rarr;
            </Link>
          </div>
      ...
      {hasRivalries && highlights && (
        <div className="bg-fab-surface border border-fab-border rounded-lg overflow-hidden">
          <div className="flex items-center justify-between px-4 py-2.5 border-b border-fab-border/50">
            ...
            <Link href="/matches?tab=opponents" className="text-xs font-semibold text-fab-gold hover:bg-fab-gold/10 px-2 py-0.5 rounded-md transition-colors">
              All opponents &rarr;
            </Link>
          </div>
