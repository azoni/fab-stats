...
import { sendTeamInvite, cancelTeamInvite } from "@/lib/teams";
import type { TeamMember, TeamInvite } from "@/types";
import { toast } from "sonner";
import { Search, X } from "lucide-react";

interface TeamInviteSearchProps {
  teamId: string;
  teamName: string;
  teamIconUrl?: string;
...
export function TeamInviteSearch({
  teamId, teamName, teamIconUrl, inviter, members, pendingInvites, onInviteSent,
}: TeamInviteSearchProps) {
