...
export function MatchList({ matches, matchOwnerUid, enableComments, editable, onUpdateMatch, onDeleteMatch, missingGemId, obfuscateOpponents = false }: MatchListProps) {
