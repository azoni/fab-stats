        ...
        {KUDOS_TYPES.map((kt) => {
          ...
          return (
            <button
              ...
              className={`flex flex-col items-center gap-0.5 w-10 sm:w-[52px] py-1 sm:py-1.5 rounded-lg transition-all ${
                !canInteract
            ...
            >
              ...
              <span className={`text-[8px] leading-tight hidden sm:block ${
