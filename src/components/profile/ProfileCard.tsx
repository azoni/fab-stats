...
export const PROFILE_THEMES: CardTheme[] = [
  ...
  // ── Themes with SVG backgrounds ──
  {
    ...
    draw: "#a1a1aa",
    barBg: "rgba(139,92,246,0.2)",
    backgroundImage: "/backgrounds/bg-royal.svg",
  },
  {
    id: "crimson",
    label: "Crimson",
    ...
    loss: "#fda4af",
    draw: "#a1a1aa",
    barBg: "rgba(220,40,80,0.2)",
    backgroundImage: "/backgrounds/bg-crimson.svg",
  },
  {
    id: "frost",
    label: "Frost",
    ...
    backgroundImage: "/backgrounds/bg-frost.svg",
  },
  {
    id: "gilded",
    label: "Gilded",
    ...
    loss: "#fca5a5",
    draw: "#a1a1aa",
    barBg: "rgba(234,179,8,0.2)",
    backgroundImage: "/backgrounds/bg-gilded.svg",
  },
  {
    id: "nebula",
    label: "Nebula",
    ...
    loss: "#fb7185",
    draw: "#a1a1aa",
    barBg: "rgba(168,85,247,0.2)",
    backgroundImage: "/backgrounds/bg-nebula.svg",
  },
];
