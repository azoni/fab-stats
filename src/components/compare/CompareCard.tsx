      ...
      <div className="px-4 pt-3 pb-3">
        ...
        <div className="flex items-center justify-between gap-2">
          <div className="text-center flex-1 min-w-0">
            ...
            {p1PowerLevel !== undefined && (
              <p style={{ color: t.accent }} className="text-lg font-black mt-0.5">{p1PowerLevel}</p>
            )}
          </div>
          ...
          <div className="text-center flex-1 min-w-0">
            ...
            {p2PowerLevel !== undefined && (
              <p style={{ color: t.accent }} className="text-lg font-black mt-0.5">{p2PowerLevel}</p>
            )}
          </div>
        </div>
