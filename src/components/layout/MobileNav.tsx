        ...
        <div className="mx-3 mb-2 bg-fab-surface border border-fab-border rounded-xl shadow-2xl overflow-hidden max-h-[70vh] overflow-y-auto">
          <div className="p-2">
            ...
            <div className="border-t border-fab-border mt-1 pt-1">
              ...
              >
                <svg className="w-5 h-5 text-fab-gold" viewBox="0 0 24 24" fill="currentColor">
              ...
              <a
                ...
                className="flex items-center gap-3 px-3 py-3 rounded-lg text-sm font-medium text-fab-text active:bg-fab-surface-hover transition-colors"
                onClick={() => { trackSupportClick("tcgplayer"); closeMore(); }}
              >
              ...
              <a
                ...
                rel="noopener noreferrer"
                className="flex items-center gap-3 px-3 py-3 rounded-lg text-sm font-medium text-fab-text active:bg-fab-surface-hover transition-colors"
                onClick={() => { trackSupportClick("github_sponsors"); closeMore(); }}
              >
              ...
              <a
                ...
                rel="noopener noreferrer"
                className="flex items-center gap-3 px-3 py-3 rounded-lg text-sm font-medium text-fab-text active:bg-fab-surface-hover transition-colors"
                onClick={() => { trackSupportClick("kofi"); closeMore(); }}
              >
              ...
              <a
                ...
                onClick={closeMore}
              >
                <svg className="w-5 h-5 text-fab-dim" viewBox="0 0 24 24" fill="currentColor">
