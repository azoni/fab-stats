...
import {
  ...
  Heart, MessageCircle, ShoppingCart, Gamepad2, Home as HomeIcon, Bot,
} from "lucide-react";
...
export const navLinks: NavLink[] = [
  ...
  { href: "/social", label: "Social", icon: <MessageCircle className="w-4 h-4" />, color: "text-sky-400", bg: "bg-sky-400/10", subItems: [
