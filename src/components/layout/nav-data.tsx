...
import {
  Mail, Star, Users, Settings, ShieldCheck,
  MessageCircle, ShoppingCart, Gamepad2, Bot,
} from "lucide-react";
...
export const navLinks: NavLink[] = [
  ...
  { href: "/social", label: "Social", icon: <NavAssetIcon name="social" />, color: "text-sky-400", bg: "bg-sky-400/10", subItems: [
  ...
  // Support kept as affiliate + feedback hub.
