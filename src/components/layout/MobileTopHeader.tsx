    ...
    <header className="fab-topbar md:hidden fixed top-0 inset-x-0 z-40 bg-fab-bg/95 backdrop-blur border-b border-fab-border pt-[env(safe-area-inset-top)]">
      <div className="flex items-center justify-between h-14 px-4">
        ...
        <Link
          href="/search"
          aria-label="Search"
          className="flex items-center justify-center w-10 h-10 rounded-lg border border-fab-border/60 text-fab-muted hover:text-fab-text hover:border-fab-gold/30 hover:bg-fab-surface-hover transition-colors"
        >
