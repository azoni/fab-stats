...
export const SEED_COSMETICS: CosmeticItem[] = [
  ...
  { id: "frame-studded-bronze", category: "avatarFrame", rarity: "common", name: "Riveted Bronze", description: "A bronze band pinned with four studs.", price: 300, previewKind: "avatarFrame", previewValue: "studded|bronze|2", gachaPool: "standard", gachaWeight: 1000, isActive: true, shopVisible: true, sortOrder: 102 },
  ...
  // ── background (secondary; grantsId → an otherwise-gated background option, so
  //    the shop is the ONLY way to unlock it; equip sets siteBackgroundId) ──
  { id: "bg-rathe-alt", category: "background", rarity: "uncommon", name: "Rathe (Alt Art)", description: "Unlock the alternate Welcome to Rathe key-art backdrop.", price: 800, previewKind: "background", previewValue: "wtr-key-art-v2", grantsId: "wtr-key-art-v2", isActive: true, shopVisible: true, sortOrder: 501 },
  { id: "bg-hunted", category: "background", rarity: "rare", name: "The Hunted", description: "Unlock the The Hunted key-art backdrop.", price: 2000, previewKind: "background", previewValue: "hunted-key-art", grantsId: "hunted-key-art", isActive: true, shopVisible: true, sortOrder: 502 },
  { id: "bg-arakni", category: "background", rarity: "epic", name: "Arakni", description: "Unlock the Arakni hero-art backdrop.", price: 5000, previewKind: "background", previewValue: "hunted-arakni-adult", grantsId: "hunted-arakni-adult", isActive: true, shopVisible: true, sortOrder: 503 },
