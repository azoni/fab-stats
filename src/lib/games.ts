...
export const GAMES: GameEntry[] = [
  {
    ...
    description: "Fill the 3x3 grid with heroes that match each row and column category.",
  ...
  },
  {
    ...
    slug: "fabdoku-card",
    label: "Card FaBdoku",
    subtitle: "Daily card puzzle",
    description: "Fill the 3x3 grid with cards that match each row and column category.",
    color: "text-teal-400",
    category: "puzzle",
    iconPath: "M4.5 5.25A2.25 2.25 0 016.75 3h10.5a2.25 2.25 0 012.25 2.25v13.5A2.25 2.25 0 0117.25 21H6.75a2.25 2.25 0 01-2.25-2.25V5.25zM8 7.5h8M8 12h8M8 16.5h5",
  },
  {
    href: "/crossword",
    slug: "crossword",
  ...
  },
  {
    ...
    // Promoted to the hub 2026-08 (was hidden) — real card art + flip reveals made
    // it hub-worthy. Listed under Puzzles so it doesn't sit alone in a Ninja section.
    category: "puzzle",
