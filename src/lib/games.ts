...
export const GAMES: GameEntry[] = [
  ...
  // ── Temporarily disabled games (pages still exist, just hidden from listing) ──
  // {
  //   href: "/rhinarsrampage", slug: "rhinarsrampage", label: "Rhinar's Rampage",
  //   subtitle: "Push your luck", description: "Roll dice to build damage. Bank or bust — can you defeat Rhinar?",
  //   color: "text-red-500", category: "dice",
  ...
  // },
  // {
  //   href: "/kayosknockout", slug: "kayosknockout", label: "Kayo's Knockout",
  //   subtitle: "Combo dice", description: "Roll 5 dice, pick combos, KO Kayo in 3 rounds. Yahtzee meets FaB.",
  //   color: "text-red-400", category: "dice",
  ...
  // },
  // {
  //   href: "/brutebrawl", slug: "brutebrawl", label: "Brute Brawl",
  //   subtitle: "Dice combat", description: "Roll attack dice vs a daily defender. Deal 20 damage to win!",
  //   color: "text-red-600", category: "dice",
  ...
  // },
  // {
  //   href: "/ninjacombo", slug: "ninjacombo", label: "Katsu's Combo",
  //   subtitle: "Build the chain", description: "Sequence 5 attack cards to maximize combo damage. Find the optimal chain!",
  //   color: "text-cyan-400", category: "ninja",
  //   iconPath: "M3.75 13.5l10.5-11.25L12 10.5h8.25L9.75 21.75 12 13.5H3.75z",
  // },
  // {
  //   href: "/shadowstrike", slug: "shadowstrike", label: "Shadow Strike",
  //   subtitle: "Match the pairs", description: "Find all 8 matching ninja card pairs in a 4×4 memory grid.",
  //   color: "text-indigo-400", category: "ninja",
  ...
  // },
  // {
  //   href: "/bladedash", slug: "bladedash", label: "Blade Dash",
  //   subtitle: "Unscramble words", description: "Unscramble 8 ninja-themed words as fast as you can.",
  //   color: "text-pink-400", category: "ninja",
