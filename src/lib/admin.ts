...
// checkIsAdmin / getAdminUid live in ./admin-check (no heavy imports) so the
// root layout can use them without pulling this whole module into every
// route. Re-exported here for existing call sites.
export { checkIsAdmin, getAdminUid } from "./admin-check";
