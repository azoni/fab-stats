...
export const CONNECTIONS_PUZZLES: ConnectionsPuzzle[] = [
  ...
  },
  {
    ...
    groups: [
      ...
      { name: "Pitch Values", words: ["Red", "Yellow", "Blue", "Rainbow"], difficulty: 4 },
    ],
  },
  {
    id: 3,
    groups: [
      ...
      { name: "Keywords with Go Again", words: ["Fai", "Dash", "Kano", "Iyslander"], difficulty: 4 },
    ],
  },
  {
    id: 4,
    groups: [
      ...
      { name: "Ranger Heroes", words: ["Azalea", "Lexi", "Riptide", "Uzuri"], difficulty: 2 },
  ...
  },
  {
    ...
    groups: [
      ...
      { name: "0-Cost Instants", words: ["Sigil of Solace", "Oasis Respite", "Tome of Fyendal", "Potion of Strength"], difficulty: 4 },
    ],
  },
  {
    id: 7,
    groups: [
      ...
      { name: "Light Talent Heroes", words: ["Boltyn", "Prism", "Solana", "Victor Goldmane"], difficulty: 3 },
  ...
  },
  {
    id: 9,
    groups: [
      { name: "Sets with 'of' in the Name", words: ["Tales of Aria", "Flesh and Blood", "Dynasty", "Outsiders"], difficulty: 1 },
  ...
  },
  {
    ...
    groups: [
      ...
      { name: "Cards with Blade Break", words: ["Engulfing Light", "Battering Bolt", "Aether Wildfire", "Voltic Bolt"], difficulty: 4 },
    ],
  },
  {
    id: 14,
    groups: [
      { name: "Head Equipment", words: ["Arcanite Skullcap", "Mask of Momentum", "Crown of Seeds", "Ironrot Helm"], difficulty: 1 },
      { name: "Chest Equipment", words: ["Fyendal's Spring Tunic", "Snapdragon Scalers", "Braveforge Bracers", "Vest of the First Fist"], difficulty: 2 },
      { name: "Arm Equipment", words: ["Nullrune Gloves", "Hope Merchant's Hood", "Crater Fist", "Grasp of the Arknight"], difficulty: 3 },
      { name: "Leg Equipment", words: ["Snapdragon Scalers", "Nullrune Boots", "Ironrot Legs", "Sandals of Surging"], difficulty: 4 },
    ],
  },
  {
    id: 15,
  ...
  },
  {
    ...
    groups: [
      ...
      { name: "Dual-Talent Heroes", words: ["Boltyn", "Chane", "Levia", "Vynnset"], difficulty: 4 },
    ],
  },
  {
    id: 19,
  ...
  },
  {
    ...
    groups: [
      ...
      { name: "Warrior Equipment", words: ["Courage of Bladehold", "Refraction Bolters", "Gallantry Gold", "Valiant Dynasty"], difficulty: 3 },
  ...
  },
  {
    ...
    groups: [
      ...
      { name: "Set Release Years (2020)", words: ["Crucible of War", "Monarch", "Welcome to Rathe", "Arcane Rising"], difficulty: 4 },
    ],
  },
  {
    id: 24,
  ...
  },
  {
    id: 25,
    groups: [
      { name: "Classes in Tales of Aria", words: ["Elemental Ranger", "Elemental Guardian", "Elemental Runeblade", "Earth Guardian"], difficulty: 1 },
      { name: "Uprising Classes", words: ["Draconic Ninja", "Draconic Illusionist", "Elemental Wizard", "Elemental Ranger"], difficulty: 2 },
      { name: "Card Subtypes", words: ["Aura", "Item", "Ally", "Landmark"], difficulty: 3 },
      { name: "Action Types", words: ["Attack", "Non-Attack Action", "Attack Reaction", "Defense Reaction"], difficulty: 4 },
    ],
  },
  {
    id: 26,
    groups: [
      { name: "Dawnblade Wielders", words: ["Dorinthea", "Boltyn", "Kassai", "Victor Goldmane"], difficulty: 1 },
      { name: "Bow Wielders", words: ["Azalea", "Lexi", "Riptide", "Uzuri"], difficulty: 2 },
      { name: "Staff Wielders", words: ["Kano", "Iyslander", "Oscilio", "Verdance"], difficulty: 3 },
      { name: "Dual-Wield Heroes", words: ["Katsu", "Benji", "Kassai", "Fai"], difficulty: 4 },
    ],
  },
  {
    id: 27,
    groups: [
      { name: "Cards Named After Heroes", words: ["Dorinthea", "Rhinar", "Katsu", "Bravo"], difficulty: 1 },
      { name: "One-Handed Weapons", words: ["Harmonized Kodachi", "Searing Emberblade", "Dagger of Shar", "Cintari Saber"], difficulty: 2 },
      { name: "Two-Handed Weapons", words: ["Dawnblade", "Anothos", "Galaxxi Black", "Rosetta Thorn"], difficulty: 3 },
      { name: "Weapons with Go Again", words: ["Harmonized Kodachi", "Searing Emberblade", "Phoenix Flame", "Spider's Bite"], difficulty: 4 },
    ],
  },
  {
    id: 28,
    groups: [
      ...
      { name: "Dynasty Heroes", words: ["Dromai", "Fai", "Emperor", "Iyslander"], difficulty: 2 },
      { name: "Everfest Heroes", words: ["Bravo Star", "Lexi", "Oldhim", "Briar"], difficulty: 3 },
  ...
  },
  {
    id: 31,
    groups: [
      { name: "Damage Keywords", words: ["Dominate", "Intimidate", "Overpower", "Piercing"], difficulty: 1 },
      { name: "Resource Keywords", words: ["Go Again", "Opt", "Draw", "Reload"], difficulty: 2 },
      { name: "Defense Keywords", words: ["Ward", "Blade Break", "Arcane Barrier", "Temper"], difficulty: 3 },
      { name: "Deck Manipulation Keywords", words: ["Opt", "Reload", "Heave", "Charge"], difficulty: 4 },
    ],
  },
  {
    id: 32,
  ...
  },
  {
    ...
    groups: [
      ...
      { name: "Misteria's Illusionists", words: ["Prism", "Enigma", "Nuu", "Spectral Shield"], difficulty: 4 },
    ],
  },
  {
    id: 35,
    groups: [
      ...
      { name: "Warrior Attack Actions", words: ["Singing Steelblade", "Out for Blood", "Hit and Run", "Ironsong Response"], difficulty: 2 },
  ...
  },
  {
    id: 37,
    groups: [
      { name: "Super Rare Equipment", words: ["Fyendal's Spring Tunic", "Arcanite Skullcap", "Snapdragon Scalers", "Crown of Seeds"], difficulty: 1 },
      { name: "Common Equipment", words: ["Ironrot Helm", "Ironrot Gauntlet", "Ironrot Legs", "Nullrune Gloves"], difficulty: 2 },
      { name: "Class-Specific Weapons", words: ["Dawnblade", "Harmonized Kodachi", "Romping Club", "Anothos"], difficulty: 3 },
      { name: "Equipment with Arcane Barrier", words: ["Nullrune Gloves", "Nullrune Boots", "Nullrune Robe", "Nullrune Hood"], difficulty: 4 },
    ],
  },
  {
    id: 38,
  ...
  },
  {
    ...
    groups: [
      ...
      { name: "0-Cost Attack Actions", words: ["Razor Reflex", "Pummel", "Overpower", "Flic Flak"], difficulty: 4 },
    ],
  },
  {
    id: 42,
  ...
  },
  {
    id: 43,
    groups: [
      { name: "Green Pitch (1) Cards", words: ["Wounding Blow", "Scar for a Scar", "Snatch", "Wounded Bull"], difficulty: 1 },
      { name: "1-Hand Weapons", words: ["Harmonized Kodachi", "Cintari Saber", "Searing Emberblade", "Dagger of Shar"], difficulty: 2 },
      { name: "Off-Hand Equipment", words: ["Talishar", "Quelling Blade", "Shield of Orum", "Buckler"], difficulty: 3 },
      { name: "Action Point Generators", words: ["Snapdragon Scalers", "Plunder Run", "Snatch", "Cash In"], difficulty: 4 },
    ],
  },
  {
    id: 44,
    groups: [
      ...
      { name: "Misteria Characters", words: ["Enigma", "Nuu", "Prism", "Miragai"], difficulty: 3 },
  ...
  },
  {
    ...
    groups: [
      ...
      { name: "Cards with the Word 'Storm'", words: ["Storm Striders", "Aether Storm", "Icy Encounter", "Lightning Storm"], difficulty: 3 },
  ...
  },
  {
    id: 48,
    groups: [
      { name: "Sets Released in 2021", words: ["Monarch", "Tales of Aria", "Everfest", "Crucible of War"], difficulty: 1 },
      { name: "Sets Released in 2022", words: ["Uprising", "Dynasty", "Outsiders", "Classic Battles"], difficulty: 2 },
  ...
  },
  {
    ...
    groups: [
      ...
      { name: "Arakni's Stealth Cards", words: ["Spider's Bite", "Surgical Extraction", "From the Shadows", "Silent Stiletto"], difficulty: 3 },
  ...
  },
  {
    ...
    groups: [
      ...
      { name: "Heroes that Use Bows", words: ["Azalea", "Lexi", "Riptide", "Uzuri"], difficulty: 3 },
  ...
  },
  {
    id: 57,
    groups: [
      { name: "Assassin Heroes", words: ["Arakni", "Uzuri", "Nuu", "Riptide"], difficulty: 1 },
      { name: "Merchant/Traveler Heroes", words: ["Kassai", "Azalea", "Briar", "Enigma"], difficulty: 2 },
      { name: "Royalty/Nobility Heroes", words: ["Emperor", "Victor Goldmane", "Kassai", "Prism"], difficulty: 3 },
      { name: "Demon-Touched Heroes", words: ["Chane", "Levia", "Vynnset", "Ursur"], difficulty: 4 },
    ],
  },
  {
    id: 58,
    groups: [
      ...
      { name: "Token-Creating Weapons", words: ["Phoenix Flame", "Rosetta Thorn", "Spider's Bite", "Voltaire"], difficulty: 4 },
    ],
  },
  {
    id: 59,
  ...
  },
  {
    ...
    groups: [
      ...
      { name: "Dusk till Dawn Heroes", words: ["Vynnset", "Prism", "Ursur", "Solana"], difficulty: 3 },
  ...
  },
  {
    id: 62,
    groups: [
      { name: "Turn Phases", words: ["Start Phase", "Action Phase", "End Phase", "Draw Step"], difficulty: 1 },
  ...
  },
  {
    id: 67,
    groups: [
      { name: "Cards Worth Over $100", words: ["Heart of Fyendal", "Eye of Ophidia", "Command and Conquer", "Fyendal's Spring Tunic"], difficulty: 1 },
      { name: "Cold Foil Staples", words: ["Arcanite Skullcap", "Mask of Momentum", "Crown of Seeds", "Snapdragon Scalers"], difficulty: 2 },
      { name: "Marvel Rarity Cards", words: ["Heart of Fyendal", "Arknight Shard", "Eye of Ophidia", "Great Library of Solana"], difficulty: 3 },
      { name: "Promo Cards", words: ["Drone of Brutality", "Aether Wildfire", "Belittle", "Plunder Run"], difficulty: 4 },
    ],
  },
  {
    id: 68,
    groups: [
      { name: "Female Heroes", words: ["Dorinthea", "Azalea", "Lexi", "Dash"], difficulty: 1 },
      { name: "Non-Human Heroes", words: ["Rhinar", "Kayo", "Data Doll", "Ursur"], difficulty: 2 },
      { name: "Heroes with Mentor Lore", words: ["Katsu", "Dorinthea", "Boltyn", "Fai"], difficulty: 3 },
      { name: "Heroes with Tragic Backstories", words: ["Chane", "Levia", "Vynnset", "Briar"], difficulty: 4 },
    ],
  },
  {
    id: 69,
  ...
  },
  {
    ...
    groups: [
      ...
      { name: "Ranger Heroes Across Sets", words: ["Azalea", "Lexi", "Riptide", "Uzuri"], difficulty: 4 },
    ],
  },
  {
    id: 79,
    groups: [
      ...
      { name: "Ally Cards", words: ["Tome of Fyendal", "Nourishing Emptiness", "Sigil of Solace", "Energy Potion"], difficulty: 2 },
  ...
  },
  {
    ...
    groups: [
      ...
      { name: "Runeblade Keywords", words: ["Runeblade", "Arcane", "Viserai", "Soul"], difficulty: 4 },
    ],
  },
  {
    id: 85,
    groups: [
      { name: "Heroes with Intellect 4", words: ["Dash", "Kano", "Iyslander", "Viserai"], difficulty: 1 },
      { name: "Heroes with Intellect 3", words: ["Dorinthea", "Katsu", "Bravo", "Rhinar"], difficulty: 2 },
      { name: "Heroes with 1-Hand Weapons", words: ["Katsu", "Kassai", "Benji", "Fai"], difficulty: 3 },
      { name: "Heroes with 2-Hand Weapons", words: ["Dorinthea", "Bravo", "Rhinar", "Viserai"], difficulty: 4 },
    ],
  },
  {
    id: 86,
  ...
  },
  {
    id: 87,
    groups: [
      { name: "Oldhim Defensive Cards", words: ["Winter's Wail", "Stalagmite", "Endless Winter", "Oaken Old"], difficulty: 1 },
      { name: "Briar Aggressive Cards", words: ["Rosetta Thorn", "Sting of Sorcery", "Embodiment of Lightning", "Channel Mount Heroic"], difficulty: 2 },
      { name: "Lexi Versatile Shots", words: ["Three of a Kind", "Ice Bolt", "Bolt'n' Shot", "Endless Winter"], difficulty: 3 },
      { name: "Fai Combo Chains", words: ["Phoenix Flame", "Rise Up", "Spreading Flames", "Lava Burst"], difficulty: 4 },
    ],
  },
  {
    id: 88,
    groups: [
      { name: "One Word Hero Names", words: ["Dash", "Bravo", "Prism", "Enigma"], difficulty: 1 },
  ...
  },
  {
    id: 90,
    groups: [
      { name: "Cards in Every Sideboard", words: ["Sink Below", "Unmovable", "Oasis Respite", "Sigil of Solace"], difficulty: 1 },
      { name: "Cards You Always Pitch", words: ["Fate Foreseen", "Energy Potion", "Sigil of Solace", "Unmovable"], difficulty: 2 },
      { name: "Cards You Never Block With", words: ["Pummel", "Razor Reflex", "Art of War", "Command and Conquer"], difficulty: 3 },
      { name: "Win Condition Cards", words: ["Crippling Crush", "Alpha Rampage", "Enlightened Strike", "Dread Screamer"], difficulty: 4 },
    ],
  },
  {
    id: 91,
  ...
  },
  {
    ...
    groups: [
      ...
      { name: "ELE Heroes", words: ["Briar", "Oldhim", "Lexi", "Tales of Aria"], difficulty: 4 },
    ],
  },
  {
    id: 93,
  ...
  },
  {
    ...
    groups: [
      ...
      { name: "Set Names That Are One Word", words: ["Monarch", "Uprising", "Dynasty", "Outsiders"], difficulty: 4 },
    ],
  },
  {
    id: 95,
    groups: [
      { name: "Heroes that Gained Living Legend", words: ["Briar", "Starvo", "Prism", "Iyslander"], difficulty: 1 },
      { name: "Most Tournament Wins (All Time)", words: ["Katsu", "Dorinthea", "Bravo", "Fai"], difficulty: 2 },
      { name: "Heroes with Multiple Versions", words: ["Dash", "Bravo", "Lexi", "Prism"], difficulty: 3 },
      { name: "Heroes Banned from Blitz at Some Point", words: ["Iyslander", "Briar", "Starvo", "Arakni"], difficulty: 4 },
    ],
  },
];
