// Zips the extension/ directory into public/fab-stats-extension.zip
...
const OUT_PATH = join("public", "fab-stats-extension.zip");
...
console.log(`Zipped ${files.length} files → ${OUT_PATH} (${zip.length} bytes)`);
